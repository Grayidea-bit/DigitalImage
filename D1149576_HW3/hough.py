...
ori = cv.imread("DigitalImage/D1149576_HW3/thresholding2.jpg",0);
rgb = cv.imread("DigitalImage/D1149576_HW3/oritest2.jpg");
...
acc,m = vote(ori);
line = findLine(ori,acc,m);
temp = drawLine(rgb,line);
temp = signName(temp,name,x,y);
cv.imwrite("DigitalImage/D1149576_HW3/finish2.jpg",temp);
